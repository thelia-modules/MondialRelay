...
abstract class MondialRelayDeliveryInsurance implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\MondialRelay\\Model\\Map\\MondialRelayDeliveryInsuranceTableMap';
    ...
    {
        $this->max_value = '0.000000';
        $this->price_with_tax = '0.000000';
    }

    /**
     * Initializes internal state of MondialRelay\Model\Base\MondialRelayDeliveryInsurance object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>MondialRelayDeliveryInsurance</code> instance.  If
     * <code>obj</code> is an instance of <code>MondialRelayDeliveryInsurance</code>, delegates to
     * <code>equals(MondialRelayDeliveryInsurance)</code>.  Otherwise, returns <code>false</code>.
     *
